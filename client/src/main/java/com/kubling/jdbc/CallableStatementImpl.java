...
public class CallableStatementImpl extends PreparedStatementImpl implements CallableStatement {
     ...
     */
    CallableStatementImpl(ConnectionImpl connection, String procedureCall, int resultSetType, int resultSetConcurrency)
            throws SQLException {
    ...
    private Time getTime(Calendar cal, Object val)
            throws SQLException {
    ...
    private Timestamp getTimestamp(Calendar cal, Object val)
            throws SQLException {
    ...
    public void registerOutParameter(int parameterIndex, int jdbcSqlType) {
