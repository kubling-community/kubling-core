...
public final class JDBCSQLTypeInfo {
    ...
    static {
        ...
        addType(
                DataTypeManager.DefaultDataTypes.GEOGRAPHY,
                Integer.MAX_VALUE,
                Integer.MAX_VALUE,
                GeographyType.class.getName(),
                Types.BLOB,
                Types.LONGVARBINARY);
        ...
        addType(
                ...
                Integer.MAX_VALUE,
                Integer.MAX_VALUE,
                SQLXML.class.getName(),
                Types.SQLXML);

        addType(
                DataTypeManager.DefaultDataTypes.NULL,
                4,
                1,
                null,
                Types.NULL);
        ...
        addType(
                ...
                DataTypeManager.MAX_VARBINARY_BYTES,
                DataTypeManager.MAX_VARBINARY_BYTES,
                byte[].class.getName(),
                Types.VARBINARY,
                Types.BINARY);
        ...
        TypeInfo typeInfo =
                new TypeInfo(Integer.MAX_VALUE, 0, "ARRAY", Array.class.getName(), new int[Types.ARRAY]);

        CLASSNAME_TO_TYPEINFO.put(Array.class.getName(), typeInfo);
        TYPE_TO_TYPEINFO.put(Types.ARRAY, typeInfo);
    }

    private static TypeInfo addType(
            String typeName, int maxDisplaySize, int precision, String javaClassName, int... sqlTypes) {
    ...
    private static void addType(
            String[] typeNames, int maxDisplaySize, int precision, String javaClassName, int... sqlTypes) {
